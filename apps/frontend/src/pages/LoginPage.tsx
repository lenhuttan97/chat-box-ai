        ...
        <Box className="glass rounded-[24px] p-8 backdrop-blur-xl border border-[color:var(--border-subtle)]/40 shadow-2xl">
          ...
          <Box className="relative mb-6">
            ...
            <Box className="relative flex justify-center text-sm">
              <Box component="span" className="px-4 text-[color:var(--text-secondary)]/50 bg-[color:var(--surface)]/50 backdrop-blur-sm">Or sign in with</Box>
            </Box>
          </Box>
          ...
          <Box className="space-y-3 mb-6">
            ...
            <Box
              component="button"
              disabled
              className="w-full h-12 flex items-center justify-center gap-3 rounded-full border border-[color:var(--border-subtle)]/40 bg-surface-3/50 text-[color:var(--text-secondary)]/40 font-medium cursor-not-allowed"
            >
