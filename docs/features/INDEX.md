...
|----|----------------|------|-------------|----------|
| FT-001 | Chat với Gemini Streaming | Full | ✅ completed | high |
...
| FT-009 | AI Service Refactor | BE | ✅ completed | high |
| FT-010 | Message Processing Pipeline | BE | ⏳ pending | high |

> **Type**: BE = Backend only | FE = Frontend only | Full = Both BE + FE

## Chi tiết theo feature

| Feature | Type | Trạng thái | Related |
|---------|------|-------------|---------|
| [chat-gemini-streaming](./chat-gemini-streaming/index.md) | Full | ✅ completed | - |
...
| [ai-service-refactor](./ai-service-refactor/index.md) | BE | ✅ completed | Tasks: T001-T003 done, T004 pending |
| [message-processing](./message-processing/index.md) | BE | ⏳ pending | Tasks: T001-T004 |
